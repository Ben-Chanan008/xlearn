                    ...
                    @foreach($enrolledCourses as $course)
                        <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-6 flex flex-col md:flex-row items-center group hover:shadow-md transition duration-300">
                            ...
                            <div class="flex-grow text-center md:text-left">
                                ...
                                <p class="text-sm text-gray-500 mb-3">By <span class="font-semibold">{{ $course['leader'] }}</span> • Last accessed {{ $course['last_accessed'] }}</p>

                                <div class="flex items-center space-x-4">
                                    <div class="flex-grow h-2 bg-gray-100 rounded-full overflow-hidden">
                                        <div class="h-full bg-primary transition-all duration-1000" style="width: {{ $course['progress'] }}%"></div>
                                    </div>
                            ...
                            <div class="mt-6 md:mt-0 md:ml-6 flex-shrink-0">
                                <a href="{{ route('courses.show', $course['id']) }}" class="inline-flex items-center justify-center px-6 py-3 bg-primary text-white font-bold rounded-2xl hover:opacity-90 transition duration-300">
